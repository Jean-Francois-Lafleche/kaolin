...
from utils import up_sample, upsample_omd, to_occpumancy_map
...
train_set = ShapeNet_ODMS(root='../../datasets/', categories=args.categories,
                          train=True, high=128, low=32, split=.97, voxels=True)
...
valid_set = ShapeNet_ODMS(root='../../datasets/', categories=args.categories,
                          train=False, high=128, low=32, split=.97, voxels=True)
